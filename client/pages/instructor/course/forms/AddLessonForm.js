...
const AddLessonForm = ({ values, setValues, handleAddLesson, uploading, uploadButtonText, handleVideo, progress, handleVideoRemove, uploadImageButtonText, handleLessonImage, handleLessonImageRemove = (f) => f, imageLessonPreview }) => {
    return (
